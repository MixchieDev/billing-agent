...
export async function fetchInvoicesForServer(
  ...
  const serialized = invoices.map((inv) => ({
    ...
    amountPaidTotal: inv.amountPaidTotal.toString(),
    balanceDue: inv.balanceDue ? inv.balanceDue.toString() : null,
    followUpPausedUntil: inv.followUpPausedUntil ? inv.followUpPausedUntil.toISOString() : null,
